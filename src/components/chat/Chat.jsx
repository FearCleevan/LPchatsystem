...
const Chat = () => {
  ...
  // Normalize chat messages to ensure `img` and `docs` are always arrays
    ...
    const unSub = onSnapshot(doc(db, "chats", chatId), (res) => {
      if (res.exists()) {
        ...
        if (
          ...
          user.id === currentUser.id // The recipient is viewing the chat
        ) {
      ...
      <div className="top">
        <div className="user">
          ...
          <div className="user-info">
            <h2 className="userName">{user?.fullname || "Unknown User"}</h2>
            <p className="userTitle">{user?.position || "Unknown Role"}</p>
          ...
          >
            {message.senderId !== currentUser.id && (
              <div className="message-user-info">
                ...
                />
                <span className="message-username">{user?.fullname || "Unknown User"}</span>
              </div>
            )}
            <div className="texts">
